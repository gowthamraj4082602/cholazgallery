...
<html>
<head>
  <title>Quotation | Cholaz Gallery</title>
...
echo '<script>alert("Thank you for submitting the documents. We will be back to you soon")</script>'; 
    ...
    $subject = "Quotation Request | Cholaz Gallery";
...
?>
        ...
        <div class="input-div one">
          ...
          <div>
            <h5>Your Name</h5>
            <input class="input" type="text" required="required" name="fname">
          </div>
        </div>
        <div class="input-div two">
          ...
          <div>
            <h5>Phone Number</h5>
            <input class="input" type="text" required="required" name="ftel"   pattern="[0-9]{10}">
          </div>
        </div>
        <a href="tel:+919080593400">Make a Call</a>
        <input type="submit" class="btn" value="Submit" name="quote">
      </form>
    </div>
  </div>
